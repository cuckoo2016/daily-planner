    ...
    <div class="auth-container">
      ...
      <div class="cute-card" :class="{ shake: shakeError }">
        <el-form ref="formRef" :model="form" :rules="rules" class="auth-form" @submit.prevent="handleRegister">
          ...
          <!-- 昵称输入框 -->
          <div class="input-wrapper" :class="{ focused: focusStates.nickname }">
            <span class="input-icon">🎀</span>
            <el-form-item prop="nickname" class="no-margin">
              <el-input
          ...
          <!-- 确认密码输入框 -->
          <div class="input-wrapper" :class="{ focused: focusStates.confirmPassword }">
            <span class="input-icon">💫</span>
          ...
          <el-form-item class="btn-container">
            ...
            >
              ...
              <span v-else-if="registerSuccess" class="success-icon">🎉</span>
        ...
        <div class="card-footer">
          ...
          <router-link to="/login" class="cute-link">
            立即登录 <span class="link-arrow">→</span>
          </router-link>
        </div>
      </div>
...
async function handleRegister() {
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      ElMessage.error(error.message || '注册失败，再试一次吧 💪');
      shakeError.value = true;
      setTimeout(() => shakeError.value = false, 500);
    } finally {
